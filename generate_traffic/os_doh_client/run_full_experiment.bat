...
REM Usage: run_full_experiment.bat [blocks] [block_seconds] [gap_seconds]
...
echo === Configuring pktmon filter (TCP 443 to/from 1.1.1.1) ===
pktmon filter remove >nul 2>&1
pktmon filter add -i 1.1.1.1 -p 443
